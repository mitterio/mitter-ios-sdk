...
class ChannelApiContainer {
    ...
    func getFetchParticipantsForChannelAction() -> FetchParticipantsForChannelAction {
        return FetchParticipantsForChannelAction(channelRepository: getChannelRepository())
    }
